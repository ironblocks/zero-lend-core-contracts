...
contract PoolPythLiquidator is VennFirewallConsumer, Pool, IExpressRelayFeeReceiver {
  ...
  function init(IPoolAddressesProvider provider, address expressRelayAddress) external virtual firewallProtected {
   ...
   */
  function receiveAuctionProceedings(bytes calldata permissionKey) external payable firewallProtected {
